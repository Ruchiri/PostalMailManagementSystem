    ...
    <div id="whole">
        ...
        <div id = "sendSection" style = "color:black">
            ...
            <form action="uploadImage.php" method="post" enctype="multipart/form-data">
               <label for="image" style = "background-color: mistyrose; width: 170px; height: 30px; text-align: center;margin-left: 700px ">ගොනු අමුනන්න</label>
                <input type="file" id="image" name="image"  >
                <br><br>
                <input type="submit"  id="upload" name="upload" value="ලිපිය අප්ලෝඩ් කරන්න"  )">
            ...
            <script>
                ...
                function attach() {
                    document.getElementById('hiddenValue').value = "set";
                }
                function delData() {
