         ...
         <ul>
            ...
            <div class=" Start-date">
                <ul>
                    ...
                    <input type="date" name="date1" id="date1"oninvalid="this.setCustomValidity('දිනය ඇතුලත් කරන්න')" required oninput="setCustomValidity('')"/>
                </ul>
            </div><!--start-date-->
            <div class="End-date">
                <ul>
                    <p>අවසාන සෙවුම් දිනය</p>
                    <input type="date" name="date2" id="date2" oninvalid="this.setCustomValidity('දිනය ඇතුලත් කරන්න')" required oninput="setCustomValidity('')" />
                </ul>
            </div><!--End-date-->
